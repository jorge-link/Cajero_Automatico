...
<head>
    ...
    <title>Retirar Dinero - Cajero Automático</title>
...
<body>
        ...
        <div class="atm-screen">
            <div class="screen-content">
                ...
                <div class="balance-display">
                    <p>Saldo disponible: <span class="balance">$<?php echo number_format($_SESSION['saldo'], 2); ?></span></p>
                </div>
                ...
                <form id="retiro-form" method="POST">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            keypadButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    if (key === 'clear') {
                        ...
                        document.getElementById('retiro-form').submit();
                    } else {
            ...
            // Animación al retirar dinero exitosamente
            <?php if($success): ?>
            setTimeout(() => {
                const moneyBills = document.querySelector('.money-bills');
                if (moneyBills) {
                    moneyBills.classList.add('dispensing');
                }
            }, 500);
            <?php endif; ?>
        });
